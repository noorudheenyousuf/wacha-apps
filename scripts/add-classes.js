...
classesNavbutton.addEventListener('click', () => {
    ...
    const classesPageHTML = `
        ...
        <div class="students-title-icon-addbutton-div">
            ...
            <button class="js-add-class-button">
    ...
    `
        ...
        <div class="overlay-div">
            ...
            <div class="addstudent-title-x-div">
                ...
                <button class="js-class-form-closebutton">X</button>
            </div>
    ...
    `
                document.querySelector('main').innerHTML = addClassWindowHTML;
                const classFormCloseButton = document.querySelector('.js-class-form-closebutton');
                classFormCloseButton.addEventListener('click', () => {
                    document.querySelector('main').innerHTML = classesPageHTML;
                    openClassForm();
                });
            });
